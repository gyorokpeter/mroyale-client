...
ListPanel.prototype.updateLayerList = function() {
    ...
    var addLayerItem = function(layer) {
        ...
        item.setAttribute("class", "list-zone");
...
ZoneTool.prototype.addLayer = function() {
    ...
    layer.data = Array(dims.y).fill(Array(dims.x).fill(30));
    this.zone.layers.splice(i,0,layer);
    app.menu.list.updateLayerList();
    app.editor.setLayer(z);
}
...
'use strict';
function _0x39e035(_0x2eef89) {
    this.texture = {};
    this.texture.cache = {};
    this.texture.load = 0;
    this.load(_0x2eef89);
}
_0x39e035.prototype.load = function (_0x2e3acb) {
    for (var _0x4b7104 = 0; _0x4b7104 < _0x2e3acb.length; _0x4b7104++) {
      var _0x44cdab = _0x2e3acb[_0x4b7104],
...
_0x39e035.prototype.loadTexture = function (_0x1a5f56) {
...
_0x39e035.prototype.getTexture = function (_0x3b3f47) {
    return this.texture.cache[_0x3b3f47];
};
_0x39e035.prototype.ready = function () {
...
function Display(_0x2c912b, _0x5f5c17, _0x580fa4, _0xa25c19) {
    this.game = _0x2c912b;
...
function EditorDisplay(_0x354c73, _0xc922a2, _0x27051f, _0x4fc009) {
    Display.call(this, _0x354c73, _0xc922a2, _0x27051f, _0x4fc009);
}
